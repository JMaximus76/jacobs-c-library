...
void            *jfs_malloc(size_t size, jcl_err_t *err) WUR;
void            *jfs_realloc(void *ptr, size_t size, jcl_err_t *err) WUR;
void             jfs_lstat(const char *path, struct stat *stat_init, jcl_err_t *err);
DIR             *jfs_opendir(const char *path, jcl_err_t *err) WUR;
void             jfs_shutdown(int sock_fd, int how, jcl_err_t *err);
struct addrinfo *jfs_getaddrinfo(const char *name, const char *port_str, const struct addrinfo *hints, jcl_err_t *err) WUR;
...
int              jfs_accept(int sock_fd, struct sockaddr *addr, socklen_t *addrlen, jcl_err_t *err) WUR;
void             jfs_connect(int sock_fd, const struct sockaddr *addr, socklen_t addrlen, jcl_err_t *err);
size_t           jfs_recv(int sock_fd, void *buf, size_t size, int flags, jcl_err_t *err) WUR;
size_t           jfs_send(int sock_fd, const void *buf, size_t size, int flags, jcl_err_t *err) WUR;
int              jfs_socket(int domain, int type, int protocol, jcl_err_t *err) WUR;
...
int              jfs_eventfd(unsigned int initval, int flags, jcl_err_t *err) WUR;
size_t           jfs_read(int fd, void *buf, size_t size, jcl_err_t *err) WUR;
size_t           jfs_write(int fd, const void *buf, size_t size, jcl_err_t *err) WUR;
void            *jfs_mmap(void *addr, size_t len, int prot, int flags, int fd, off_t off, jcl_err_t *err) WUR;
void            *jfs_aligned_alloc(size_t align, size_t size, jcl_err_t *err) WUR;
